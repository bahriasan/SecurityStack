...
Implements and Enables Security Services(SecurityAccess and Authentication) with CSM/CryIf/CryptoDriver AUTOSAR Classic Modules and using OpenSSL as SW Crypto Driver.
